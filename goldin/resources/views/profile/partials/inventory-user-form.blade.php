<section>
    ...
    <div id="alertWeaponUnits" class="alert alert-danger alert-dismissible fade show m-3 position-relative hideCard" role="alert">
        <span id="alert-messageWeaponUnits"></span>
    </div>
    <header>
                ...
                <div class="d-flex justify-content-center mt-3 flex-wrap">
                    <div id="weapon-container-{{ $weapon->id }}" class="mx-2 mb-3 dark:bg-gray-800 d-flex flex-column justify-content-between weapon-container" style="border-color: {{ $weapon->color }};">
                        ...
                        <div class="d-flex justify-content-center weapon-buttons">
                            ...
                            <button type="button" class="btn btn-primary withdraw-button" data-weapon-id="{{ $weapon->id }}">Withdraw</button>
                        </div>
                    </div>
                </div>
            @empty
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-gray-800 text-white">
            <div class="p-6 bg-gray-800">
                ...
                <p class="mt-1 text-sm text-gray-400">
                    Are you sure you want to withdraw this weapon?
                </p>
                <div class="mt-6 flex justify-end">
