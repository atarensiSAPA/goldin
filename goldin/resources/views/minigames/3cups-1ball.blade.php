...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            ...
            <div id="cups-container" aria-label="Cups">
                <div class="cup" id="cup1" aria-hidden="true"></div>
                <div class="cup" id="cup2" aria-hidden="true"></div>
                <div class="cup" id="cup3" aria-hidden="true"></div>
            </div>
        </div>
