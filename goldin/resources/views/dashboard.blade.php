<x-app-layout>
    <div class="container" data-coin-url="{{ asset('images/user_coin.png') }}">
        <div class="mt-2">
            ...
            @forelse ($clothes as $c)
                <div class="col-md-3 mt-4 d-flex">
                    <div class="card bg-transparent text-white d-flex flex-column align-items-center" id="card-{{ $c->name }}">
                        ...
                        <!-- Add to cart button -->
                        <button class="btn btn-primary add-to-cart-button position-absolute top-0 end-0 me-3 mt-1 displayNone" id="add-to-cart-{{ $c->id }}" data-clothes-id="{{ $c->id }}" data-clothes-name="{{ $c->name }}" data-clothes-price="{{ $c->price }}" data-clothes-img="{{ $c->clothes_img }}">
                            🛒
                        </button>
                    </div>
                </div>
        ...
        <div class="modal-dialog text-light">
            <div class="modal-content">
                ...
                <div class="modal-footer modal-body bg-gray-100 dark:bg-gray-900">
                    ...
                    <button type="button" class="btn btn-primary btnCart" id="addToCartButton">Add to cart</button>
                </div>
            </div>
        </div>
    </div>
